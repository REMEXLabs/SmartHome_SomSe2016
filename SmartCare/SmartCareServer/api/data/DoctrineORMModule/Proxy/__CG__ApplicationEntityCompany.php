...
class Company extends \Application\Entity\Company implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Company' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Company' . "\0" . 'name', '' . "\0" . 'Application\\Entity\\Company' . "\0" . 'street', '' . "\0" . 'Application\\Entity\\Company' . "\0" . 'zip', '' . "\0" . 'Application\\Entity\\Company' . "\0" . 'city'];
        }
